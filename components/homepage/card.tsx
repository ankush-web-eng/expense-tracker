...
export default function Card() {
  ...
  return (
    <div className="border-slate-400-500 rounded-lg border-2 p-4 dark:border-slate-400">
      <div className="flex flex-col px-2 space-y-2 md:space-y-5 p-4 rounded-lg bg-slate-100 dark:bg-slate-600 w-fit border-sky-500 dark:border-slate-400">
        <div className="flex items-center justify-between w-full">
          <span className="px-8 text-slate-600">Money Left: </span>
          <span className="px-8 text-slate-600">Rs. {500}</span>
        </div>
        <div className="flex items-center justify-between w-full">
          <span className="px-8 text-slate-600">Money Spent: </span>
          <span className="px-8 text-slate-600">Rs. {150}</span>
        </div>
        ...
        <div className="flex justify-between px-6 gap-2">
          <Link href="/income">
          <button className="w-fit hover:bg-blue-400 active:bg-teal-700 bg-sky-500 dark:bg-sky-400 text-white rounded-lg p-2">
            Income History
          </button>
          </Link>
          <Link href="/expenses">
